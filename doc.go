...
//	------	   			--
//
//	decimal.Decimal            ↔    pickle.Class{"decimal", "Decimal"}
//	decimal.Decimal("3.14")    ↔    pickle.Call{
//						pickle.Class{"decimal", "Decimal"},
//						pickle.Tuple{"3.14"},
//					}
//
...
//
// On decoding pickle detects which protocol is being used and automatically
// handles all necessary details.
//
// On encoding, for compatibility with Python2, by default pickle produces
...
//
// When a pickle with such persistent reference is decoded, pickle represents
...
// not by standard Python2. Respectively, for protocol ≤ 2, what pickle produces
